...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.01.23, April 06, 2023 07:57:39):
...
app_logger.info(f'Created April 06, 2023 07:57:39 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.01.23\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.01.23\n'
    if is_docker():
