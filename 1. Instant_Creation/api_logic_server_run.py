...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.01.16, March 29, 2023 17:17:42):
...
app_logger.info(f'Created March 29, 2023 17:17:42 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.01.16\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.01.16\n'
    if is_docker():
