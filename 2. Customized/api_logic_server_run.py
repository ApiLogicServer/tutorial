...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.03.10, May 07, 2023 09:06:32):
...
app_logger.info(f'Created May 07, 2023 09:06:32 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.03.10\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.03.10\n'
    if is_docker():
