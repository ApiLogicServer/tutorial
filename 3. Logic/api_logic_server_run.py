...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.03.08, May 06, 2023 21:52:08):
...
app_logger.info(f'Created May 06, 2023 21:52:08 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.03.08\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.03.08\n'
    if is_docker():
