...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.00.01, February 15, 2023 22:26:17):
...
app_logger.info(f'Created February 15, 2023 22:26:17 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.00.01\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.00.01\n'
    if is_docker():
