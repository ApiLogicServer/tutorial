...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.01.11, March 14, 2023 06:30:16):
...
app_logger.info(f'Created March 14, 2023 06:30:16 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.01.11\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.01.11\n'
    if is_docker():
